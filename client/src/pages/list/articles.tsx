...
export default function ArticlesPage() {
  ...
  // Get articles with content_type = 'articles'
  const { data: articles = [], isLoading } = useQuery({
    queryKey: ["articles", "content-type", "articles", sortOrder],
    queryFn: () => getArticles({ 
    ...
    <div className="py-8 px-4 max-w-6xl mx-auto">
      ...
      {isLoading ? (
        ...
        <div className="bg-zinc-900/50 rounded-lg p-10 text-center">
          <p className="text-zinc-400 mb-4">You don't have any articles saved yet.</p>
          <Link href="/save">
